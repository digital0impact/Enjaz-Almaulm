      ...
      >
        ...
        >
          ...
          >
            ...
            {/* Add Comment Form */}
            {showAddForm && (
              <ThemedCard style={styles.addForm}>
                      ...
                      {(['عام', 'تعليمي', 'إداري', 'تقني'] as const).map((category) => (
                        <TouchableOpacity
                          ...
                          style={[
                            ...
                            { backgroundColor: newComment.category === category ? getCategoryColor(category) : '#f0f0f0' }
                          ]}
                      ...
                      {(['عادي', 'مهم', 'عاجل'] as const).map((priority) => (
                        <TouchableOpacity
                          ...
                          style={[
                            ...
                            { backgroundColor: newComment.priority === priority ? getPriorityColor(priority) : '#f0f0f0' }
                          ]}
            ...
            <ScrollView style={styles.content}>
              {comments.length === 0 ? (
                <ThemedView style={styles.emptyState}>
                  <IconSymbol size={60} name="text.bubble" color="#ccc" />
                ...
                <ThemedView style={styles.commentsList}>
                  {comments.map((comment) => (
                    <ThemedCard key={comment.id} style={styles.commentCard}>
