  ...
  const performanceData = [
    {
      ...
      weight: 10,
      category: 'وظيفي',
      details: 'التزام عالي بالدوام الرسمي، تنفيذ ممتاز للحصص الدراسية وفق الجدول المحدد، ومشاركة فعالة في الإشراف والمناوبة والانتظار.',
      strengths: ['الالتزام بالدوام', 'تنفيذ الحصص بانتظام', 'المشاركة في الإشراف'],
      improvements: ['تطوير مهارات التخطيط الدرسي'],
    },
    {
      id: 2,
      ...
      weight: 10,
      category: 'تفاعلي',
      details: 'مشاركة نشطة في مجتمعات التعلم المهنية، تبادل منتظم للزيارات الصفية، وتنفيذ دروس تطبيقية متميزة.',
      strengths: ['المشاركة النشطة', 'تبادل الخبرات', 'الدروس التطبيقية'],
      improvements: ['زيادة عدد ورش العمل المحضورة'],
    },
    {
      id: 3,
      ...
      weight: 10,
      category: 'تفاعلي',
      details: 'تواصل ممتاز مع أولياء الأمور وتزويدهم بمستويات أبنائهم بشكل دوري، إيصال الملاحظات الهامة.',
      strengths: ['التواصل المستمر', 'الشفافية في التقييم', 'المتابعة الدورية'],
      improvements: ['تنويع وسائل التواصل'],
    },
    {
      id: 4,
      ...
      weight: 10,
      category: 'تعليمي',
      details: 'تطبيق متميز لاستراتيجيات تدريس متنوعة ومتطورة، مراعاة دقيقة للفروق الفردية بين الطلاب.',
      strengths: ['التنويع في الاستراتيجيات', 'مراعاة الفروق الفردية', 'استخدام طرق حديثة'],
      improvements: ['دمج المزيد من التقنيات الحديثة'],
    },
    {
      id: 5,
      ...
      weight: 10,
      category: 'تعليمي',
      details: 'جهود متميزة في معالجة الفاقد التعليمي، وضع خطط علاجية شاملة للطلاب الضعاف وخطط إثرائية للمتميزين.',
      strengths: ['معالجة الفاقد التعليمي', 'الخطط العلاجية', 'برامج الإثراء'],
      improvements: ['تطوير أساليب التقييم التكويني'],
    },
  ];
