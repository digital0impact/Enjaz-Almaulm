...
- **قائمة الخيارات:**  
  `معلم/ة`، `معلم/ة مسند له نشاط طلابي`، `معلم/ة مسند له توجيه صحي`، `الموجه/ه الطلابي`، `وكيل/ة المدرسة`، `مدير/ة المدرسة`، `التشكيلات الإشرافية المشتركة`، `التشكيلات الإشرافية`.
...
- **الربط:**
  ...
  - `else if (profession === 'التشكيلات الإشرافية المشتركة')` → محاور **الجدارات المشتركة** (المسؤولية، العمل الجماعي، المرونة للتغيير، المبادرة).
  - `else if (profession === 'التشكيلات الإشرافية')` → محاور **الجدارات القيادية** (المسؤولية، العمل الجماعي، المرونة للتغيير، المبادرة، قيادة التغيير، تطوير وتمكين الموظفين، التوجه الاستراتيجي، اتخاذ القرارات).
