...
### إذا لم يظهر الاشتراك بعد الدفع

- **ويب هوك سلة**: تأكد من ربط حدث «تم إنشاء الطلب» أو «تم تأكيد الدفع» في سلة بعنوان الـ Edge Function `store-subscription-webhook`.
- **مطابقة العميل**: الـ Webhook يربط الطلب بالمستخدم عبر **البريد** أو **رقم الجوال**. يجب أن يكون البريد أو رقم الجوال في طلب سلة مطابقاً لما في التطبيق (الإعدادات → البيانات الأساسية). إن اختلف الرقم أو البريد لن يُربَط الاشتراك بالمستخدم.
- **التأخير**: التطبيق يعيد المحاولة تلقائياً (فوراً، بعد 2 و 5 و 10 ثوانٍ) عند العودة من الدفع. إن لم يظهر الاشتراك، اضغط زر «تحديث» في صفحة الاشتراكات أو حدّث الصفحة بعد عدة ثوانٍ.
